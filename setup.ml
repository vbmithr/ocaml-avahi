...
(* OASIS_START *)
(* DO NOT EDIT (digest: 26968660282bd308da0e096ee5726d65) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                      ...
                      bs_cclib =
                        [
                           (OASISExpr.EBool true,
                             ["-lavahi-common"; "-lavahi-client"; "-ldbus-1"])
                        ];
                   ...
                   {
                      lib_modules =
                        ["Avahi"; "Strlst"; "Watch"; "Client"; "Lookup"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "H\217\236\197(h\222\1415\170\252^H\195\192\208";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
